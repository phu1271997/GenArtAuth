...
- **Locked-Stake Challenges**: Anyone can dispute a verified verdict by filing a challenge with a **10 GEN stake** and submitting new evidence.
...
- **Stake-Locked Incentives**: If the jury overturns the verdict, the challenger is refunded and receives a **5 GEN reward**. If the verdict is upheld, the stake is forfeited.
